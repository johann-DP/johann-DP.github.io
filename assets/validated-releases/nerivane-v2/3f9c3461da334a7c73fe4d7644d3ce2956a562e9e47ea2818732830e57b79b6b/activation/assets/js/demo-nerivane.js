...
(() => {
  ...
  function render(data) {
    ...
    headingCopy.append(element("p", "nerivane-eyebrow", "Registre public scellé"));
    ...
    journeyCopy.append(element("p", "nerivane-eyebrow", "Parcours prospect"));
    journeyCopy.append(element("h2", "", "Sept étapes, chacune reliée à sa preuve"));
